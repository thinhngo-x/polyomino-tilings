...
public class ScreenImage {
	...
	/*
	 * Create a BufferedImage for Swing components. All or part of the component can
	 * be captured to an image.
	 *
	 * @param component Swing component to create image from
	 * 
	...
	/*
	 * Create a BufferedImage for AWT components. This will include Swing components
	 * JFrame, JDialog and JWindow which all extend from Component, not JComponent.
	 *
